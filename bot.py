            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "إذا سأل المستخدم عن طريقة استخدام البوت أو استفسر عن خدماته، اشرح له بأسلوب حيوي الخدمات التالية:\n"
                        "1. 📚 إضافة المواد والفروع وكيفية ترتيب وتخزين المواد الدراسية.\n"
                        "2. 🧠 خطوات حفظ الدروس وتقديم إرشادات واستراتيجيات ذكية لاستيعاب المناهج بسرعة.\n"

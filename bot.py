            ...
            response = requests.post(
                ...
                json={
                    ...
                    "messages": [
                        ...
                        "إذا سأل المستخدم عن طريقة استخدام البوت، أو استفسر عن خدماته بشكل عام بأي صيغة كانت، "
                        "يجب عليك أن تشرح له بوضوح وبأسلوب حيوي ومرتب الخدمات التالية: "
                        "1. 📚 إضافة المواد والفروع وشرح كيفية ترتيب وتخزين المواد الدراسية الخاصة بهم. "
                        "2. 🧠 خطوات حفظ الدروس وتقديم إرشادات واستراتيجيات ذكية ومجربة لحفظ المناهج واستيعابها بسرعة. "
                        "3. 📅 تنظيم المهام والجدول وإدارة المهام اليومية والمراجعات بكل سهولة. "
